...
public class Console {
    ...
    private BufferedReader bufferedReader =
		...
		//#region Utils
			...
			/** OS Independent: Utilidad para limpiar la consola en cualquier sistema operativo, incluyendo Windows, Mac y Linux.
				* Utility to clear the console in any operating system, including Windows, Mac and Linux.
				* @Author Manuel Rosendo Castro Iglesias
				* @Author Adaptación por ChatGPT {@link https://chat.openai.com/chat}
				* To use it, call the console.cls() method where you need to clean the console.
				* Para usarlo, llama al método console.cls() donde necesites limpiar la consola.
				*/
			public void cls() {
